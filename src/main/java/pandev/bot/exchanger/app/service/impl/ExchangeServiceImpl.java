...
public class ExchangeServiceImpl implements ExchangeService {
    ...
    @Override
    public String getUSDExchangeRate() throws RuntimeException {
        var xml = client.getCurrencyRatesXML();
        return extractCurrencyValueFromXML(xml, Command.USD_XPATH);
    }
    @Override
    public String getKZTExchangeRate() throws RuntimeException {
        var xml = client.getCurrencyRatesXML();
    ...
    @Override
    public String getConverted(String currency, Double amount){
        var xml = client.getCurrencyRatesXML();
